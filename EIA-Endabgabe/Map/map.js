...
let WindowsArray = [
    "<h3>Kölner Dom</h3> Cologne Cathedral is the landmark of the city. It was built from 1248 to 1880 and is one of the largest Gothic cathedrals. According to the legend, it contains the bones of the three holy kings. As soon as you arrive at Cologne Central Station, you can see the Grey Monster.",
    "<h3>Kebab Land</h3> Kebab Land is the secret highlight of Cologne. Many people in Cologne would call it the best snack in the world, so you can never eat there without first lining up in a long queue full of hungry visitors. Here you get the best kebab plate, but also the vegetarian offers make your mouth watering.",
    "<h3>Rhein Treppen</h3> The RheinTreppen are a perfect place on the Rheinboulevard to contemplate the beautiful skyline of Cologne. They are located on the right side of the Rhine, giving you a perfect view of the cathedral. Many people make themselves comfortable here on the stairs at sunset with a beer and a snack and let the evening end romantically.",
    ...
    "<h3>Schokoladen Museum</h3> In the Chocolate Museum you can find out all about chocolate. We all love chocolate but how is it made? What's its story? Where's it from? In addition to chocolate information, you will also get delicious tastings in this museum and can try yourself as a chocolatier.",
